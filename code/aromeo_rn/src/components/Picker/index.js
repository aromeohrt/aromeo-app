...
ScrollPicker.defaultProps = {
  ...
  itemTextStyle: { fontSize: 20, lineHeight: 26, textAlign: 'center', color: 'gray', fontFamily: 'Montserrat-Medium' },
  activeItemTextStyle: { fontSize: 20, lineHeight: 26, textAlign: 'center', color: '#ffffff', fontFamily: 'Montserrat-Medium' }
};